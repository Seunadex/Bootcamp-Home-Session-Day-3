...
describe("Find missing number two lists: ", function() {
  ...
  describe("Case for lists with similar entries and a missing number", function() {
    ...
    it("should return 7 for [5, 7, 2, 9],[9, 2, 5]", function() {
      expect(findMissing([5, 7, 2, 9], [9, 2, 5])).toEqual(7);
    });

    it("should return 19 for [10, 33, 29, 19],[33, 29, 10]", function() {
      expect(findMissing([10, 33, 29, 19], [33, 29, 10])).toEqual(19);
    });
